...
"%VS110COMNTOOLS%..\ide\devenv" FlylinkDC_2012.sln /Rebuild "Release|Win32"
...
svn log > changelog-flylinkdc-r5xx-github.txt

for /l %%i in (1,1,20) do echo @tools\replace_str.vbs " | %%i lines" "" changelog-flylinkdc-r5xx-github.txt
