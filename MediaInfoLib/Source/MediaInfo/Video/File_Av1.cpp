...
void File_Av1::sequence_header()
{
    ...
    bool reduced_still_picture_header, seq_tier[33], decoder_model_info_present_flag=false, seq_choose_screen_content_tools, mono_chrome, color_range=0, color_description_present_flag, subsampling_x, subsampling_y;
    BS_Begin();
