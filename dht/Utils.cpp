...
bool Utils::isGoodIPPort(const string& ip, uint16_t port)
{
	...
	// [+] SSA - http://code.google.com/p/flylinkdc/issues/detail?id=254 Ѕлокировать вход€щие соединени€ через DHT из заблокированного IPGuard-ом диапазона адресов.
 ...
 */
CID Utils::getUdpKey(const string& targetIp) // TODO - часто зоветс€.
{
