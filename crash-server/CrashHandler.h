...
struct HandlerSettings
{
	...
	DWORD   FullDumpType;               //!< The type of information to be generated when full dump is requested by Crash Server. This parameter can be one or more of the values from the MINIDUMP_TYPE enumeration.
...
public:
		...
		) throw()
	{
		...
		InitCrashHandler(&appInfo, &handlerSettings, ownProcess);
	}
