...
//#define FLYLINKDC_USE_ASK_SLOT // îòêëþ÷àåì àâòîïîïðîøàéêó
#define FLYLINKDC_USE_USE_UNORDERED_SET_SHAREMANAGER
//#define FLYLINKDC_USE_ONLINE_SWEEP_DB // Óäàëÿòü ôàéëû èç áàçû äàííûõ åñëè îíè ïðîïàëè èç êàòàëîãà.
//#define FLYLINKDC_USE_VACUUM

#define FLYLINKDC_USE_DOS_GUARD // Âêëþ÷àåì çàùèòó îò DoS àòàêè ñòàðûõ âåðñèé
...
#ifdef _DEBUG
//# define FLYLINKDC_USE_HIGH_LOAD_FOR_SEARCH_ENGINE_IN_DEBUG // Îòäàåì íà ïîèñê áîëüøå äàííûõ - â ðåëèçå íèêîãäà íå âêëþ÷àòü
#endif
...
//#define IRAINMAN_SPEED_LIMITER_5S4_10 // Âêëþ÷àåò îãðàíè÷åíèå: ñêîðîñòü îòäà÷è = 5 * êîëè÷åñòâî ñëîòîâ + 4, ñêîðîñòü çàãðóçêè = 10 * ñêîðîñòü îòäà÷è
//#define IRAINMAN_INCLUDE_USER_CHECK // - Íå ïîíÿë íàõðåíà îíî íóæíî. åñëè þçåðîâ 100 òûù òî ÷òî áóäåò?
...
#ifdef _DEBUG
// #define RIP_USE_LOG_PROTOCOL // âûêëþ÷èë ò.ê. ñèëüíî ãðóçèò ñèñòåìó
#endif
...
//#define NIGHTORION_INTERNAL_TRANSLATE_SOCKET_ERRORS // Âêëþ÷èòü êîãäà áóäåò ãîòîâ ïåðåâîä.
...
//#define USE_OFFLINE_ICON_FOR_FILELIST  Íóæíà äîðàáîòêà. // not yet implemented, don't turn on

// SSA_SAVE_LAST_NICK_MACROS íèãäå íå þçàåòñÿ
...
// #define FLYLINKDC_USE_MEDIAINFO_SERVER_COLLECT_LOST_LOCATION // Íå ñîáèðàåòñÿ ñòàòà (íåêîìó îáðàáàòûâàòü)
...
//#define FLYLINKDC_USE_LIST_VIEW_WATER_MARK // Ñâèñòåëêó îòðóáèòü
//#define FLYLINKDC_USE_LIST_VIEW_MATTRESS   // Îòêëþ÷àåì ïîëîñàòûå ëèñòâüþ (áåñòîëêîâàÿ òðàòà ðåñóðñîâ)


#define FLYLINKDC_USE_CHECK_GDIIMAGE_LIVE
#ifdef _DEBUG
// #define FLYLINKDC_USE_COLLECT_STAT  // Ñîáèðàåì ñòàòèñòèêó êîìàíä êîííåêòîâ è ïîèñêà äëÿ áëîêèðîâêè DDoS àòàê http://dchublist.ru/forum/viewtopic.php?f=6&t=1028&hilit=Ddos
