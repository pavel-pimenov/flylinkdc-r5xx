...
#endif
#define IRAINMAN_INCLUDE_SOCKET_IN_BUFFER_OPTION
...
#define CRITICAL_SECTION_SPIN_COUNT 10000 // [+] IRainman opt. http://msdn.microsoft.com/en-us/library/windows/desktop/ms683476(v=vs.85).aspx You can improve performance significantly by choosing a small spin count for a critical section of short duration. For example, the heap manager uses a spin count of roughly 4,000 for its per-heap critical sections.
