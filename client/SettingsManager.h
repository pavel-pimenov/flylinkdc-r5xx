...
class SettingsManager : public Singleton<SettingsManager>, public Speaker<SettingsManagerListener>
{
	public:
		...
		enum StrSetting { STR_FIRST,
		                  ...
		                  LOG_FORMAT_WEBSERVER, LOG_FORMAT_CUSTOM_LOCATION, LOG_FORMAT_TRACE_SQLITE, LOG_FORMAT_DDOS_TRACE, LOG_FORMAT_DHT_TRACE, LOG_FORMAT_PSR_TRACE, WEBSERVER_USER, WEBSERVER_PASS, LOG_FILE_MAIN_CHAT,
		                  LOG_FILE_PRIVATE_CHAT, LOG_FILE_STATUS, LOG_FILE_UPLOAD, LOG_FILE_DOWNLOAD, LOG_FILE_SYSTEM, LOG_FORMAT_SYSTEM,
		                  LOG_FORMAT_STATUS, LOG_FILE_WEBSERVER, LOG_FILE_CUSTOM_LOCATION, LOG_FILE_TRACE_SQLITE, LOG_FILE_DDOS_TRACE, LOG_FILE_DHT_TRACE, LOG_FILE_PSR_TRACE,
		...
		enum IntSetting { INT_FIRST = STR_LAST + 1,
		                  ...
		                  LOG_SQLITE_TRACE, LOG_DDOS_TRACE, LOG_DHT_TRACE, LOG_PSR_TRACE,
