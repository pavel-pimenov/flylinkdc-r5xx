...
//		typedef SearchTypes::const_iterator SearchTypesIterC;
		...
		enum IntSetting { INT_FIRST = STR_LAST + 1,
		                  ...
		                  NO_IP_OVERRIDE, GROUP_SEARCH_RESULTS, FORGET_SEARCH_REQUEST, SAVE_SEARCH_SETTINGS, SAVED_SEARCH_TYPE, SAVED_SEARCH_SIZEMODE, SAVED_SEARCH_MODE, BOLD_FINISHED_DOWNLOADS, BOLD_FINISHED_UPLOADS, BOLD_QUEUE,
		                  ...
		                  PM_PREVIEW, FILTER_ENTER, POPUP_TIME, POPUP_W, POPUP_H, POPUP_TRANSP, AWAY_TIME_THROTTLE, AWAY_START, AWAY_END, PROGRESSBAR_ODC_BUMPED, TOP_SPEED, STEALTHY_STYLE, STEALTHY_STYLE_ICO, STEALTHY_STYLE_ICO_SPEEDIGNORE, PSR_DELAY,
		                  IP_IN_CHAT, COUNTRY_IN_CHAT, TOP_UP_SPEED, BROADCAST, REMEMBER_SETTINGS_PAGE, PAGE, REMEMBER_SETTINGS_WINDOW_POS, SETTINGS_WINDOW_POS_X, SETTINGS_WINDOW_POS_Y, SETTINGS_WINDOW_SIZE_X, SETTINGS_WINDOW_SIZE_YY, SETTINGS_WINDOW_TRANSP, SETTINGS_WINDOW_COLORIZE, SETTINGS_WINDOW_WIKIHELP, CHATBUFFERSIZE, ENABLE_HUBTOPIC, ENABLE_HUBMODE_PIC, ENABLE_COUNTRYFLAG, PG_LAST_UP,
...
#define SPLIT_SETTING(key) Util::splitSetting(SETTING(key))
// [~] IRainman: copy-past fix.
