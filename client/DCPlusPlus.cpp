...
#define LOAD_STEP_L(locale_key, load_function)\
	...
	// Çàãðóçêó êîíôèãà íóæíî äåëàòü ðàíüøå
...
#endif
	LOAD_STEP("P2P Guard", Util::loadP2PGuard()); // Ýòîò ãðóçèòü âñåãäà ïåðâûì - âûïîëíÿåò çà÷èñòêó áàçû
...
{
	// Ñîõðàíèì ìàðêåðû âðåìåíè çàâåðøåíèÿ
#ifndef _DEBUG
	...
	
	{
		...
		preparingCoreToShutdown(); // Çîâåì òóò âòîðîé ðàç ò.ê. âåðîÿòíî ïðè àâòîîáíîâëåíèè îíî íå çîâåòñÿ.
