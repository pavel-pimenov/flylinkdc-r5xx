...
#endif
{
	...
	private:
		...
		static int g_columnIndexes[/* [!] IRainman: don't uncomment this! ÏÎÊÓÑÀÞ! COLUMN_LAST*/];
		static int g_columnSizes[/* [!] IRainman: don't uncomment this! ÏÎÊÓÑÀÞ! COLUMN_LAST*/];
