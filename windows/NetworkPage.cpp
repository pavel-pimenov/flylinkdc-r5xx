...
void NetworkPage::fixControls()
{
	...
	//SetStage(IDC_NETWORK_TEST_PORT_DHT_UDP_ICO, dht ? StageWait : StageUnknown); // StageUnknown - не показываетс€
	...
	// ¬ернул редакцию IP http://flylinkdc.com/forum/viewtopic.php?f=23&t=1294&p=5065#p5065
