	...
	try
	{
		...
		while (l_count_mirror < 2)
		{
			...
			if (l_download_size)
			{
				...
				"items":
				[
				"Çàðóáåæíûå ôèëüìû", "Íàøè ôèëüìû", "Íàó÷íî-ïîïóëÿðíûå ôèëüìû", "Ñåðèàëû ", "Òåëåâèçîð", "Ìóëüòèïëèêàöèÿ ", "Àíèìå ", "Ìóçûêà", "Èãðû ", "Ñîôò ", "Ñïîðò è Çäîðîâüå", "Þìîð", "Õîçÿéñòâî è Áûò", "Êíèãè ", "Äðóãîå"
				]
				}
				*/
				Json::Value l_root;
