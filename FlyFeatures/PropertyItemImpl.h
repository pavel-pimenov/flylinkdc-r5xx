...
public:
   CProperty(LPCTSTR pstrName, LPARAM lParam) : m_fEnabled(true), m_lParam(lParam), m_hWndOwner(NULL)
   {
      ...
      ATLTRY( m_pszName = new TCHAR[ (::wcslen(pstrName) * sizeof(TCHAR)) + 1 ] ); // [!] PVS V303 The function 'lstrlen' is deprecated in the Win64 system. It is safer to use the 'wcslen' function. propertyitemimpl.h 53
      ATLASSERT(m_pszName);
...
public:
   ...
   {      
      ...
      USES_CONVERSION;
      ::wcsncpy(pstr, OLE2CT(v.bstrVal), cchMax); // [!] PVS V303 The function 'lstrcpyn' is deprecated in the Win64 system. It is safer to use the 'wcsncpy' function. propertyitemimpl.h 203
      return TRUE;
   }
   ...
   UINT GetDisplayValueLength() const
   {
      ...
      USES_CONVERSION;
      return v.bstrVal == NULL ? 0 : ::wcslen(OLE2CT(v.bstrVal)); // [!] PVS V303 The function 'lstrlen' is deprecated in the Win64 system. It is safer to use the 'wcslen' function. propertyitemimpl.h 215
   }
...
public:
   ...
   CPropertyDateItem(LPCTSTR pstrName, const SYSTEMTIME &stValue, LPARAM lParam) : // [!] PVS V801 Decreased performance. It is better to redefine the second function argument as a reference. Consider replacing 'const .. stValue' with 'const .. &stValue'. propertyitemimpl.h 426
      CPropertyEditItem(pstrName, lParam)
   {
      m_val.vt = VT_DATE;
...
public:
   ...
   BOOL GetDisplayValue(LPTSTR pstr, UINT cchMax) const
   {
      ...
      *pstr = _T('\0');
      ...
      ::wcsncpy(pstr, pstrFileName, cchMax); // [!] PVS V303 The function 'lstrcpyn' is deprecated in the Win64 system. It is safer to use the 'wcsncpy' function. propertyitemimpl.h 626
      return TRUE;
   }
   ...
   UINT GetDisplayValueLength() const
   {
      ...
      return ::wcslen(szPath); // [!] PVS V303 The function 'lstrlen' is deprecated in the Win64 system. It is safer to use the 'wcslen' function. propertyitemimpl.h 634
   }
};
...
public:
   ...
   BOOL GetDisplayValue(LPTSTR pstr, UINT cchMax) const
   {
      ...
      *pstr = _T('\0');
      ...
      USES_CONVERSION;
      ::wcsncpy( pstr, OLE2CT(m_arrList[m_val.lVal]), cchMax) ; // [!] PVS V303 The function 'lstrcpyn' is deprecated in the Win64 system. It is safer to use the 'wcsncpy' function. propertyitemimpl.h 721
      return TRUE;
   }
   ...
   UINT GetDisplayValueLength() const
   {
      ...
      USES_CONVERSION;
      return bstr == NULL ? 0 : ::wcslen(OLE2CT(bstr)); // [!] PVS V303 The function 'lstrlen' is deprecated in the Win64 system. It is safer to use the 'wcslen' function. propertyitemimpl.h 731
   }
...
inline HPROPERTY PropCreateDate(LPCTSTR pstrName, const SYSTEMTIME &stValue, LPARAM lParam = 0) // [!] PVS V801 Decreased performance. It is better to redefine the second function argument as a reference. Consider replacing 'const .. stValue' with 'const .. &stValue'. propertyitemimpl.h 943
{
